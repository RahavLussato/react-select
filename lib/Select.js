	...
	render: function render() {
		...
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					'div',
					{ ref: 'values', className: 'row col-xs-10 middle-xs', style: {overflowY:'auto'} },
					this.renderValue(valueArray, isOpen),
					this.renderInput(valueArray)
				),
				_react2['default'].createElement(
					'div',
					{ ref: 'options', className: 'row middle-xs col-xs-1' },
					this.renderLoading(),
					this.renderClear()
				),
				_react2['default'].createElement(
					'div',
					{ ref: 'options', className: 'row middle-xs col-xs-1', style: {paddingLeft:0} },
					this.renderArrow()
				)
			),
